...
def run_home_app():
    ...
    Text_diab2 = ('<p style="font-family:Arial;color:black;font-size:16px;"> Diabetes is a long-lasting health condition that affects how your body turns food into energy. Diabetes cause insufficient blood sugar in your body’s cells for use as energy. A small cut or a fall might be dangerous. Over time, that can cause serious health problems such as heart disease, vision loss, and kidney disease.</p>')
    st.markdown(Text_diab2,unsafe_allow_html=True)

    Text_Mental = ('<p style="font-family:Arial;color:black;font-size:16px;">Are you at risk of Diabetes? Lets find out...</p>')
